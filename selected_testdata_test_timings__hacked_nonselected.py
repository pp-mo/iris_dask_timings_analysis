...
data_inds = np.array([test_class not in selected_test_classes
                      for test_class in test_classes])
selected_data = data[data_inds]
present_test_classes = sorted(list(set(selected_data['test_class'])))
print 'N selected test classes = ', len(present_test_classes)
...
#
class_totals_map = {}
for class_name in present_test_classes:
